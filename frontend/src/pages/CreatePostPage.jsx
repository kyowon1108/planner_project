                ...
                <Box sx={{ p: 4 }}>
                  ...
                  <form onSubmit={handleSubmit}>
                    <TextField
                      ...
                      InputProps={{
                        startAdornment: <Edit sx={{ mr: 1, color: darkMode ? '#b0b0b0' : 'text.secondary' }} />,
                      }}
                      required
                    />
                    ...
                    <TextField
                      ...
                      InputProps={{
                        startAdornment: <Article sx={{ mr: 1, color: darkMode ? '#b0b0b0' : 'text.secondary', alignSelf: 'flex-start', mt: 1 }} />,
                      }}
                      required
                    />
