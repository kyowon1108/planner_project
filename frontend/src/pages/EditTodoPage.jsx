...
const EditTodoPage = () => {
  ...
  // 플래너 선택 시 팀 정보 가져오기
  const fetchTeamData = async (plannerId) => {
  ...
  const handleSave = async () => {
    ...
    try {
      await todoAPI.updateTodo(todo.id, {
        ...
        description.trim(),
        priority,
        due_date ? `${dueDate}T00:00` : null,
        planner_id,
        assigned_to.length > 0 ? assignedTo : null,
      });
              ...
              >
                <Box sx={{ p }}>
                  ...
                  <TextField
                    ...
                    InputProps={{
                      startAdornment: <DescriptionIcon sx={{ mr, color ? '#b0b0b0' : 'text.secondary', alignSelf: 'flex-start', mt }} />,
                    }}
                  />
                  ...
                  <TextField
                    ...
                    InputProps={{
                      startAdornment: <ScheduleIcon sx={{ mr, color ? '#b0b0b0' : 'text.secondary' }} />,
                    }}
                  />
